...
export function BookCard({ book, shelfId, onRemove }: BookCardProps) {
  ...
  const removeFromShelfMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch(`/api/shelves/${shelfId}/books/${book.id}`, {
        method: "DELETE",
        credentials: "include",
      });
      ...
      <AlertDialog open={isRemoveDialogOpen} onOpenChange={setIsRemoveDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove "{book.title}" from this shelf? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{book.title}"? This will remove it from all shelves and cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
